...
if (-not $eligibleAssignments) {
    Write-Host "There is no Eligible role assignments found for the user."
    return
}
...
# Show avaiable roles and let the user select
...
# Read selection and convert to list of roles
